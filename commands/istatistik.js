...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .addFields({ name: 'Bot Sahibi', value: `Shro`, inline: false})
    ...
    .addFields({ name: '• Bot Kuruluş', value: `12.11.2022`, inline: true})
    .addFields({ name: '• Komut Sayısı', value: `28 Adet Komutum Var`, inline: true})
